...
pub const BOLT12_FETCH_INVOICE_PATH: &str = "Bolt12FetchInvoice";
pub const BOLT12_PAY_INVOICE_PATH: &str = "Bolt12PayInvoice";
pub const ABANDON_BOLT12_INVOICE_PATH: &str = "AbandonBolt12Invoice";
